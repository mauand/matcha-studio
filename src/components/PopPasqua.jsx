    ...
    <>
      <PopUp trigger={showPopUp} setTrigger={setShowPopUp}>
        <div
          ...
          className="fixed top-0 left-0 bg-white bg-opacity-70 h-[100vh] w-[100vw] z-[90] p-2 flex justify-center items-center"
        >
          <div className="h-[30rem] w-11/12 lg:w-[50rem] lg:h-[25rem] bg-[url('https://ik.imagekit.io/mauand/tr:w-1500/matcha-studio/video.jpg')] bg-cover bg-center rounded-xl relative shadow-2xl">
            <button
              onClick={() => setShowPopUp(false)}
            ...
            <div className="w-full h-full bg-black/50 z-10 p-4 lg:p-8 rounded-xl flex flex-col justify-center items-center">
              ...
              <div className="flex gap-4 items-baseline mb-2">
                <h2 className="lg:text-[6rem] text-[5rem] text-primary title-shadow">70€</h2>
                <h3 className="lg:text-[2.5rem] line-through text-slate-300 ">105€</h3>
              </div>
