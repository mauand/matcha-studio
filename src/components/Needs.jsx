...
const Needs = () => {
  return (
    <div className='px-4'>
        ...
        <div>
                <img src="/matcha-studio/1yogi.png" alt="yogi uno" className='w-4/5 mx-auto'/>
                <h4 className='uppercase'>IL DESIDERIO DI SENTIRTI BENE</h4>
            </div>
            <div>
                <img src="/matcha-studio/2yogi.png" alt="yogi uno" className='w-4/5 mx-auto'/>
                <h4 className='uppercase'>UN PICCOLO SPAZIO TRANQUILLO</h4>
            </div>
            <div>
                <img src="/matcha-studio/3yogi.png" alt="yogi uno" className='w-4/5 mx-auto'/>
                <h4 className='uppercase'>UN MOMENTO PER  IL TUO BENESSERE</h4>
            </div>
            <div>
                <img src="/matcha-studio/4yogi.png" alt="yogi uno" className='w-4/5 mx-auto'/>
