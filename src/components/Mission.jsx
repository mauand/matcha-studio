...
const Description = () => {
  return (
    <div className="px-0 rounded-md bg-[#566743]">
      <div className="px-4 py-16">
        <h3 className="uppercase mb-4 text-gray-100">La nostra <br />mission</h3>
        ...
        <h2 className="mb-4 text-[#F8AA71]">Pratico e accessibile </h2>
